...
<div class='box'>
<h4>Lennart core</h4>
<p>Lennart core modules.</p>
<ul>
<?php foreach($modules as $module): ?>
  <?php if($module['isLennartCore']): ?>
  <li><a href='<?=create_url("module/view/{$module['name']}")?>'><?=$module['name']?></a></li>
  <?php endif; ?>
<?php endforeach; ?>
</ul>
...
<div class='box'>
<h4>Lennart CMF</h4>
<p>Lennart Content Management Framework (CMF) modules.</p>
<ul>
<?php foreach($modules as $module): ?>
  <?php if($module['isLennartCMF']): ?>
  <li><a href='<?=create_url("module/view/{$module['name']}")?>'><?=$module['name']?></a></li>
  <?php endif; ?>
<?php endforeach; ?>
</ul>
...
<div class='box'>
<h4>More modules</h4>
<p>Modules that does not implement any specific Lennart interface.</p>
<ul>
<?php foreach($modules as $module): ?>
  <?php if(!($module['isController'] || $module['isLennartCore'] || $module['isLennartCMF'])): ?>
  <li><a href='<?=create_url("module/view/{$module['name']}")?>'><?=$module['name']?></a></li>
  <?php endif; ?>
<?php endforeach; ?>
</ul>
