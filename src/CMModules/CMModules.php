<?php
/**
 * A model for managing Lennart modules.
 * 
 * @package LennartCore
 */
class CMModules extends CObject {
   ...
   * Properties
   */
  private $lennartCoreModules = array('CLennart', 'CDatabase', 'CRequest', 'CViewContainer', 'CSession', 'CObject');
  private $lennartCMFModules = array('CForm', 'CCPage', 'CCBlog', 'CMUser', 'CCUser', 'CMContent', 'CCContent', 'CFormUserLogin', 'CFormUserProfile', 'CFormUserCreate', 'CFormContent', 'CHTMLPurifier');
  ...
  private function GetDetailsOfModule($module) {
    ...
    if(class_exists($module)) {
      ...
      $details['isLennartCore']   = in_array($rc->name, $this->lennartCoreModules);
      $details['isLennartCMF']    = in_array($rc->name, $this->lennartCMFModules);
